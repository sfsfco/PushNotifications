<header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>{{env('site_title')}}</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Session::get('admin')['username']}} - Administrator
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('admins.create') }}"><i class="fa fa-circle-o"></i> Add Admin</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{ route('campaigns.index') }}"><i class="fa fa-circle-o"></i> Campaigns</a></li>
            <li><a href="{{ route('campaigns.create') }}"><i class="fa fa-circle-o"></i> Add Campaign</a></li>
          </ul>
        </li>
