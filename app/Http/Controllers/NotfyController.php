    ...
    public function index()
    {
        ...
        foreach ($campaigns as $camp) {
            ...
            foreach($results as $rows){
                ...
                )),'payload'=>'{"message":"'.$camp->message.'", "topic":"'.$camp->title.'", "icon":"'.$camp->icon.'", "image":"'.$camp->image.'", "link":"'.$camp->link.'", "explore":"'.$camp->explore.'", "explore_icon":"'.$camp->explore_icon.'", "dir":"'.$camp->dir.'"}');
